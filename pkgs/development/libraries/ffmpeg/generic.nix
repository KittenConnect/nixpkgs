...
, withNvcodec ? withHeadlessDeps && (with stdenv; !isDarwin && !isFreeBSD && !isAarch32 && !hostPlatform.isRiscV && hostPlatform == buildPlatform) # dynamically linked Nvidia code
...
, withV4l2M2m ? withV4l2 && !stdenv.hostPlatform.isFreeBSD
