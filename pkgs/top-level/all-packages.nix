...

{
  ...
  less = if stdenv.isFreeBSD then freebsd.less else super.less; # TODO: Find a wae
  ...
  accountsservice-linux = callPackage ../development/libraries/accountsservice { };  # TODO: Find a way to integrate correctly FreeBSD # Shoulkd be in by-name
  accountsservice-freebsd = callPackage ../development/libraries/accountsservice/freebsd.nix { }; # TODO: Find a way to integrate correctly FreeBSD # Shoulkd be in by-name
  accountsservice = if stdenv.isFreeBSD then accountsservice-freebsd else accountsservice-linux; # TODO: Find a way to integrate correctly FreeBSD # Shoulkd be in by-name
